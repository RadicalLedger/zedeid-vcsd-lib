...
test('Create a masked verifiable presentation', async () => {
    const credential_1 = {
        '@context': [
            'https://www.w3.org/2018/credentials/v1',
            'https://d202eicx1ap3m7.cloudfront.net/credentials/microrewards/v0-01/microrewards-schema-v0-03.json'
...
test('Verify a verifiable presentation without issuer and holder public keys', async () => {
    const credential_1 = {
        '@context': [
            'https://www.w3.org/2018/credentials/v1',
            'https://d202eicx1ap3m7.cloudfront.net/credentials/microrewards/v0-01/microrewards-schema-v0-03.json'
...
test('Verify a masked verifiable presentation without issuer and holder public keys', async () => {
    const credential_1 = {
        '@context': [
            'https://www.w3.org/2018/credentials/v1',
            'https://d202eicx1ap3m7.cloudfront.net/credentials/microrewards/v0-01/microrewards-schema-v0-03.json'
