...
declare const _default: {
    ...
    verify: ({ suite, challenge, domain, vp, documentLoader, issuerPublicKey, holderPublicKey, didMethod }: VerifyProps) => Promise<import("@transmute/vc.js/dist/types").VerificationResult>;
};
