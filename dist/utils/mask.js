...
const createMask = ({ mask = {}, credentialSubject = {}, holderPublicKey }) => {
        ...
        for (let key = 0; key < credentialSubject.length; key++) {
            ...
            if (maskValues) {
                if (credentialSubject === null || credentialSubject === void 0 ? void 0 : credentialSubject[key]) {
                    try {
                        const maskedKey = (0, functions_1.blind)(credentialSubject[key], holderPublicKey);
            ...
            if (maskValues) {
                ...
                if (credentialSubject === null || credentialSubject === void 0 ? void 0 : credentialSubject[key]) {
                    try {
                        ...
                        maskedClaims[maskedKey] = (0, functions_1.blind)(credentialSubject[key], holderPublicKey);
    ...
    return {
        maskedClaims: (0, functions_1.sortObject)(maskedClaims),
        maskedMasks: (0, functions_1.sortObject)(maskedMasks)
    };
};
/**
 * Generate selective masked claim set of a partially masked claim set in sorted order
